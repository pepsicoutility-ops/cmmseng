...
<head>
    ...
    <title>PM Checklist Completed - PEPSICO CMMS</title>
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4">
        <div class="max-w-md w-full">
            <div class="bg-white rounded-lg shadow-lg p-8 text-center">
                ...
                <!-- Success Message -->
                <h1 class="text-2xl font-bold text-gray-900 mb-2">PM Checklist Completed!</h1>
                <p class="text-gray-600 mb-6">Your preventive maintenance checklist has been successfully recorded.</p>

                <!-- PM Info -->
                <div class="bg-blue-50 rounded-lg p-4 mb-6">
                    <p class="text-sm text-gray-600 mb-1">PM Checklist</p>
                ...
                <div class="text-left bg-gray-50 rounded-lg p-4 mb-6">
                    <p class="text-sm text-gray-600 mb-2">✓ PM execution recorded</p>
                ...
                <div class="space-y-3">
                    @if($token)
                    <a href="{{ route('barcode.pm-checklist', ['token' => $token]) }}" 
