...
<head>
    ...
    <title>Chiller 2 Checklist - PEPSICO CMMS</title>
    ...
    <div class="container mx-auto px-4 py-6 max-w-2xl pb-20">
        ...
        <div class="bg-white rounded-lg shadow-md p-4 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-xl font-bold text-gray-800">Chiller 2 Checklist</h1>
        ...
        <!-- Form -->
        <form id="chiller2Form" method="POST" action="{{ route('barcode.chiller2.submit') }}" class="space-y-4">
            @csrf
            ...
            <div class="bg-white rounded-lg shadow-md p-4">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <select name="shift" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="gpid" id="gpid" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500" placeholder="Enter GPID">
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-4">
                ...
                <div>
                    <textarea name="notes" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500" placeholder="Any observations or issues..."></textarea>
                </div>
            </div>

            <!-- Submit Button -->
            <div class="sticky bottom-0 bg-white border-t border-gray-200 p-4 -mx-4">
                <button type="submit" class="w-full bg-amber-600 text-white font-semibold py-3 px-4 rounded-lg hover:bg-amber-700 active:bg-amber-800">
                    Submit Checklist
                </button>
            </div>
        </form>
