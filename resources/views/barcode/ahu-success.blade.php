...
<head>
    ...
    <title>AHU Checklist Submitted - PEPSICO CMMS</title>
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4">
        <div class="max-w-md w-full">
            <div class="bg-white rounded-lg shadow-lg p-8 text-center">
                ...
                <!-- Success Message -->
                <h1 class="text-2xl font-bold text-gray-900 mb-2">AHU Checklist Submitted!</h1>
                <p class="text-gray-600 mb-6">Your checklist has been successfully recorded.</p>

                <!-- Checklist Info -->
                <div class="bg-indigo-50 rounded-lg p-4 mb-6">
                    <p class="text-sm text-gray-600 mb-1">AHU Checklist</p>
                    <p class="text-lg font-bold text-indigo-600">Shift {{ $shift }}</p>
                    @if($gpid)
                ...
                <div class="space-y-3">
                    @if($token)
                    <a href="{{ route('barcode.ahu', ['token' => $token]) }}" 
                        class="block w-full bg-indigo-600 text-white py-3 rounded-lg font-semibold hover:bg-indigo-700 transition">
