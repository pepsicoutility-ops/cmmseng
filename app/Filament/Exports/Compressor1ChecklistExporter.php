...
class Compressor1ChecklistExporter extends Exporter
{
    ...
    {
        $body = 'Your compressor 1 checklist export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
