...
class Chiller1TableWidget extends BaseWidget
{
    ...
    {
        return $table
            ->heading('Chiller 1 - Recent Checklists (Last 7 Days)')
            ->query(
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('loading')
                    ->label('FLA Loading %')
                    ->state(function (Chiller1Checklist $record): string {
                        if ($record->fla > 0) {
                    ...
                    ->color(function (Chiller1Checklist $record): string {
                        if ($record->fla > 0) {
                            $loading = ($record->lcl / $record->fla) * 100;
